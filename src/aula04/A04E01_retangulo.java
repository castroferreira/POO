...
public class A04E01_retangulo {
	private int comprimento, largura;
	private String cor;
	private A04E01_ponto centro;

	public A04E01_retangulo(int comprimento, int largura,  A04E01_ponto centro, String cor){
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		A04E01_retangulo other = (A04E01_retangulo) obj;
		if (centro == null) {
